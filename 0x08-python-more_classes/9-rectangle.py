...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """compares two rectangle object in terms of areas

        Args:
            rect_1: first rectangle object
            rect_2: second rectangle object

        Return: The bigger rectangle object or rect_1 if both are equal
                An exception with an informative message is raised if needed
        """
    ...
    def square(cls, size=0):
        """Returns a new rectangle instance with equal sides (square)

        Args:
            size: The dimenstion for the square
        """
